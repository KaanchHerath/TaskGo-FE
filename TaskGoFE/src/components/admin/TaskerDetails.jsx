        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-900 bg-white p-3 rounded border">
                  {tasker.taskerProfile?.bio || 'No bio provided'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Advance Payment Required</label>
                <p className="mt-1 text-sm text-gray-900">
                  ${tasker.taskerProfile?.advancePaymentAmount || 0}
                </p>
              </div>
            </div>
          </div>
