      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900">{task.customer.email}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900">{formatDate(task.customer.createdAt)}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          task.customer.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                        }`}>
                          {task.customer.isActive ? 'Active' : 'Inactive'}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Email Verified:</span>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                          task.customer.isEmailVerified ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                        }`}>
                          {task.customer.isEmailVerified ? 'Yes' : 'No'}
                        </span>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="space-y-4">
                          <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                <span className="text-gray-600">Email:</span>
                                <span className="text-gray-900">{tasker.email}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-600">Phone:</span>
                              ...
                              <div className="flex justify-between">
                                <span className="text-gray-600">Member Since:</span>
                                <span className="text-gray-900">{formatDate(tasker.createdAt)}</span>
                              </div>
                            </div>
                          </div>
          ...
          {activeTab === 'applications' && (
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-gray-500">{task.applicationCount || 0} applications</span>
              </div>
              
              {task.relatedData?.recentApplications && task.relatedData.recentApplications.length > 0 ? (
                <div className="space-y-4">
                  {task.relatedData.recentApplications.map((application, index) => (
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          <div className="text-sm font-medium text-gray-900">
                            {formatCurrency(application.proposedPayment)}
                          </div>
                      ...
                      <div className="mt-3 flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-4">
                          <span className="text-gray-600">
                            Rating: <span className="text-gray-900">{application.tasker?.rating || 'N/A'}</span>
                          </span>
                          <span className="text-gray-600">
                            Experience: <span className="text-gray-900">{application.tasker?.taskerProfile?.experience || 'N/A'}</span>
                          </span>
                        </div>
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-mono text-gray-900">{task._id}</span>
          </div>
          <div className="flex items-center space-x-3">
            <button
              onClick={onClose}
